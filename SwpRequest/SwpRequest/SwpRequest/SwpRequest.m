...
+ (instancetype)allocWithZone:(struct _NSZone *)zone{
    ...
    dispatch_once(&onceToken, ^{
        _swpRequest = [super allocWithZone:zone];
    });
    return _swpRequest;
}
...
#pragma makr - SwpRequest Public Tools Methods
/**!
 *  @ author swp_song
 *
 ...
 *  @ author swp_song
 *
 *  @ brief  swpRequestGetAppKey    ( 获取 appKey )
 *
 *  @ return NSString
 */
+ (NSString *)swpRequestGetAppKey {
    return [SwpRequest shareInstance].swpRequestAppKey;
}
 ...
 *  @ author swp_song
 *
 *  @ brief  POST:parameters:isEncrypt:uploadFileStatus:fileNames:fileDatas:swpResultSuccess:swpResultError:    ( 网络请求核心方法  )
 *
 *  @ param  URLString                       请求的 url
 *
 *  @ param  parameters                      请求 需要传递的参数
